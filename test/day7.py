...
class Day7(TestBase):
    ...
    def getAmpOutput(self, line: str, phases: List[int]):
        io = 0
        for phase in phases:
    ...
    def test(self):
        ...
        self.assertEqual(43210, self.process('3,15,3,16,1002,16,10,16,1,16,15,15,4,15,99,0,0'))
        ...
        self.assertEqual(54321, self.process('3,23,3,24,1002,24,10,24,1002,23,-1,23,101,5,23,23,1,24,23,23,4,23,99,0,0'))
